...
/*      */     }
/*      */ 
/*  727 */     label372: if ((last == 2) && (fitsInLong) && ((value != -9223372036854775808L) || (negative))) {
...
/*      */     throws IOException
/*      */   {
/* 1413 */     label104: for (; (this.pos + toFind.length() <= this.limit) || (fillBuffer(toFind.length())); this.pos += 1)
 ...
 * Qualified Name:     com.newrelic.com.google.gson.stream.JsonReader
