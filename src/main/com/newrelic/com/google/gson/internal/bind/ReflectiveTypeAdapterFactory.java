...
/*     */     }
/*     */ 
/*  71 */     ObjectConstructor constructor = this.constructorConstructor.get(type);
...
/*     */       }
/*     */ 
/* 162 */       Object instance = this.constructor.construct();
/*     */       try
/*     */       {
/* 165 */         in.beginObject();
/* 166 */         while (in.hasNext()) {
/* 167 */           String name = in.nextName();
/* 168 */           ReflectiveTypeAdapterFactory.BoundField field = (ReflectiveTypeAdapterFactory.BoundField)this.boundFields.get(name);
 ...
 * Qualified Name:     com.newrelic.com.google.gson.internal.bind.ReflectiveTypeAdapterFactory
