...
/* 184 */     AtomicReference result = new AtomicReference();
/* 185 */     new TypeVisitor() {
/*     */       void visitTypeVariable(TypeVariable<?> t) {
/* 187 */         this.val$result.set(Types.subtypeOfComponentType(t.getBounds()));
/*     */       }
/*     */       void visitWildcardType(WildcardType t) {
/* 190 */         this.val$result.set(Types.subtypeOfComponentType(t.getUpperBounds()));
/*     */       }
/*     */       void visitGenericArrayType(GenericArrayType t) {
/* 193 */         this.val$result.set(t.getGenericComponentType());
/*     */       }
/*     */       void visitClass(Class<?> t) {
/* 196 */         this.val$result.set(t.getComponentType());
/*     */       }
/*     */     }
/* 185 */     .visit(new Type[] { type });
/*     */ 
...
/* 486 */       ImmutableList.Builder builder = ImmutableList.builder();
...
/* 394 */       if ((obj instanceof Serializable)) {
/* 395 */         WildcardType that = (Serializable)obj;
...
/*     */     {
/* 304 */       if (!(other instanceof Serializable)) {
/* 305 */         return false;
/*     */       }
/* 307 */       ParameterizedType that = (Serializable)other;
...
/*     */ 
/*     */     public boolean equals(Object obj) {
/* 246 */       if ((obj instanceof Serializable)) {
/* 247 */         GenericArrayType that = (Serializable)obj;
...
/*     */ 
/* 131 */     private static ClassOwnership detectJvmBehavior() { Class subclass = new 1LocalClass() {  } .getClass();
 ...
 * Qualified Name:     com.newrelic.com.google.common.reflect.Types
