...
/*     */   {
/*  91 */     Map mappings = Maps.newHashMap();
...
/*     */   {
/*     */     try {
/* 207 */       return type.cast(arg); } catch (ClassCastException e) {
/*     */     }
...
/*     */     {
/* 227 */       ImmutableMap.Builder builder = ImmutableMap.builder();
/* 228 */       builder.putAll(this.map);
/* 229 */       for (Map.Entry mapping : mappings.entrySet()) {
 ...
 * Qualified Name:     com.newrelic.com.google.common.reflect.TypeResolver
