...
/*     */ import com.newrelic.com.google.common.collect.ImmutableSet.Builder;
/*     */ import com.newrelic.com.google.common.collect.ImmutableSortedSet;
/*     */ import com.newrelic.com.google.common.collect.ImmutableSortedSet.Builder;
...
/*  91 */     for (Map.Entry entry : getClassPathEntries(classloader).entrySet()) {
...
/* 122 */     ImmutableSet.Builder builder = ImmutableSet.builder();
...
/* 138 */     ImmutableSet.Builder builder = ImmutableSet.builder();
...
/*     */   {
/* 280 */     LinkedHashMap entries = Maps.newLinkedHashMap();
/*     */ 
...
/* 347 */         return;
/*     */       }
/* 349 */       ImmutableSet newAncestors = ImmutableSet.builder().addAll(ancestors).add(canonical).build();
/*     */ 
...
/*     */         }
/* 378 */         Enumeration entries = jarFile.entries();
...
/*     */       }
/* 404 */       ImmutableSet.Builder builder = ImmutableSet.builder();
 ...
 * Qualified Name:     com.newrelic.com.google.common.reflect.ClassPath
