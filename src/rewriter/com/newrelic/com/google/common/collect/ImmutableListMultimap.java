...
/*     */     {
/* 249 */       ImmutableListMultimap kvMultimap = (ImmutableListMultimap)multimap;
/*     */ 
...
/*     */     }
/*     */ 
/* 256 */     ImmutableMap.Builder builder = ImmutableMap.builder();
/* 257 */     int size = 0;
/*     */ 
/* 260 */     for (Map.Entry entry : multimap.asMap().entrySet()) {
/* 261 */       ImmutableList list = ImmutableList.copyOf((Collection)entry.getValue());
/* 262 */       if (!list.isEmpty()) {
...
/*     */   {
/* 285 */     ImmutableList list = (ImmutableList)this.map.get(key);
...
/*     */     }
/* 356 */     ImmutableMap.Builder builder = ImmutableMap.builder();
/*     */ 
/* 358 */     int tmpSize = 0;
/*     */ 
 ...
 * Qualified Name:     com.newrelic.com.google.common.collect.ImmutableListMultimap
