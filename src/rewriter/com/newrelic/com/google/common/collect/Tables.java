...
/*     */     {
/* 574 */       Function wrapper = Tables.access$000();
...
/*     */     {
/* 494 */       Function wrapper = Tables.access$000();
...
/*     */     {
/* 525 */       Function wrapper = Tables.access$000();
...
/*     */     {
/* 355 */       return contains(rowKey, columnKey) ? this.function.apply(this.fromTable.get(rowKey, columnKey)) : null;
/*     */     }
/*     */ 
/*     */     public int size()
/*     */     {
...
/* 377 */       return contains(rowKey, columnKey) ? this.function.apply(this.fromTable.remove(rowKey, columnKey)) : null;
/*     */     }
/*     */ 
...
/* 390 */       return new Function() {
/*     */         public Table.Cell<R, C, V2> apply(Table.Cell<R, C, V1> cell) {
/* 392 */           return Tables.immutableCell(cell.getRowKey(), cell.getColumnKey(), Tables.TransformedTable.this.function.apply(cell.getValue()));
/*     */         }
/*     */       };
/*     */     }
/*     */ 
...
/* 418 */       Function rowFunction = new Function()
/*     */       {
...
/* 428 */       Function columnFunction = new Function()
/*     */       {
 ...
 * Qualified Name:     com.newrelic.com.google.common.collect.Tables
