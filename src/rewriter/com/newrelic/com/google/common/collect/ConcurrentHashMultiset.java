...
/*     */   {
/*  99 */     ConcurrentHashMultiset multiset = create();
...
/*     */   {
/* 190 */     List list = Lists.newArrayListWithExpectedSize(size());
/* 191 */     for (Multiset.Entry entry : entrySet()) {
/* 192 */       Object element = entry.getElement();
...
/*     */   {
/* 449 */     final Set delegate = this.countMap.keySet();
/* 450 */     return new ForwardingSet() {
...
/*     */   {
/* 496 */     final Iterator readOnlyIterator = new AbstractIterator()
/*     */     {
...
/*     */           }
/* 505 */           Map.Entry mapEntry = (Map.Entry)this.mapEntries.next();
...
/*     */       }
/*     */     };
/* 514 */     return new ForwardingIterator() {
...
/* 522 */         this.last = ((Multiset.Entry)super.next());
...
/*     */ 
/* 575 */     ConcurrentMap deserializedCountMap = (ConcurrentMap)stream.readObject();
/*     */ 
...
/* 557 */       List list = Lists.newArrayListWithExpectedSize(size());
/*     */ 
 ...
 * Qualified Name:     com.newrelic.com.google.common.collect.ConcurrentHashMultiset
