...
/*     */   {
/* 228 */     Ordering ordering = builder.ordering();
...
/* 258 */     for (Iterator i$ = newElements.iterator(); i$.hasNext(); ) { Object element = i$.next();
/* 259 */       offer(element);
/* 260 */       modified = true;
/*     */     }
/* 262 */     return modified;
...
/* 387 */       return null;
/*     */     }
/* 389 */     Object actualLastElement = elementData(this.size);
/* 390 */     int lastElementAt = heapForIndex(this.size).getCorrectLastElement(actualLastElement);
/*     */ 
/* 392 */     Object toTrickle = elementData(this.size);
/* 393 */     this.queue[this.size] = null;
/* 394 */     MoveDesc changes = fillHole(index, toTrickle);
...
/*     */   {
/* 449 */     Object value = elementData(index);
/* 450 */     removeAt(index);
/* 451 */     return value;
/*     */   }
/*     */ 
...
/*     */       }
/* 522 */       else parent = MinMaxPriorityQueue.this.elementData(getParentIndex(removeIndex));
/*     */ 
...
/* 556 */         Object e = MinMaxPriorityQueue.this.elementData(grandParentIndex);
...
/* 616 */       Object parentElement = MinMaxPriorityQueue.this.elementData(parentIndex);
...
/*     */         {
/* 626 */           Object uncleElement = MinMaxPriorityQueue.this.elementData(uncleIndex);
...
/*     */         {
/* 658 */           Object uncleElement = MinMaxPriorityQueue.this.elementData(uncleIndex);
...
/* 164 */     private int maximumSize = 2147483647;
/*     */ 
...
/*     */     {
/* 206 */       MinMaxPriorityQueue queue = new MinMaxPriorityQueue(this, MinMaxPriorityQueue.initialQueueSize(this.expectedSize, this.maximumSize, initialContents), null);
/*     */ 
/* 208 */       for (Iterator i$ = initialContents.iterator(); i$.hasNext(); ) { Object element = i$.next();
 ...
 * Qualified Name:     com.newrelic.com.google.common.collect.MinMaxPriorityQueue
