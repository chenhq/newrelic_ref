...
/*  191 */       Object element = list.get(from);
...
/*  239 */     Iterator iterator = removeFrom.iterator();
/*  240 */     while (iterator.hasNext()) {
/*  241 */       Object next = iterator.next();
...
/*      */   {
/*  315 */     Collection collection = toCollection(iterable);
/*  316 */     Object[] array = ObjectArrays.newArray(type, collection.size());
...
/*  351 */       Collection c = Collections2.cast(elementsToAdd);
...
/*  392 */     return new FluentIterable()
/*      */     {
/*      */       public Iterator<T> iterator() {
/*  395 */         return Iterators.cycle(this.val$iterable);
/*      */       }
/*      */       public String toString() {
/*  398 */         return this.val$iterable.toString() + " (cycled)";
/*      */       }
/*      */     };
/*      */   }
/*      */ 
...
/*      */   {
/*  508 */     return new TransformedIterator(iterables.iterator())
/*      */     {
...
/*  728 */     return (iterable instanceof List) ? ((List)iterable).get(position) : Iterators.get(iterable.iterator(), position);
/*      */   }
/*      */ 
/*      */   @Nullable
...
/*  751 */       List list = Lists.cast(iterable);
/*  752 */       return position < list.size() ? list.get(position) : defaultValue;
/*      */     }
/*  754 */     Iterator iterator = iterable.iterator();
...
/*  808 */       Collection c = Collections2.cast(iterable);
/*  809 */       if (c.isEmpty())
...
/*  849 */       List list = (List)iterable;
/*  850 */       return new FluentIterable()
/*      */       {
/*      */         public Iterator<T> iterator()
/*      */         {
...
/*      */     }
/*      */ 
/*  860 */     return new FluentIterable()
/*      */     {
/*      */       public Iterator<T> iterator() {
/*  863 */         final Iterator iterator = this.val$iterable.iterator();
/*      */ 
...
/*      */           public T next()
/*      */           {
/*  882 */             Object result = iterator.next();
...
/*  942 */       return new FluentIterable()
/*      */       {
/*      */         public Iterator<T> iterator() {
/*  945 */           return new Iterables.ConsumingQueueIterator((Queue)this.val$iterable, null);
/*      */         }
/*      */ 
/*      */         public String toString()
/*      */         {
...
/* 1022 */     Iterable iterable = new FluentIterable()
/*      */     {
/*      */       public Iterator<T> iterator() {
...
/*      */       try {
/*  979 */         return this.queue.remove(); } catch (NoSuchElementException e) {
/*      */       }
 ...
 * Qualified Name:     com.newrelic.com.google.common.collect.Iterables
