...
/*     */   {
/* 317 */     final Comparator comparator = columnComparator();
/*     */ 
/* 319 */     final Iterator merged = Iterators.mergeSorted(Iterables.transform(this.backingMap.values(), new Function()
/*     */     {
...
/*     */     }), comparator);
/*     */ 
/* 328 */     return new AbstractIterator()
/*     */     {
/*     */       C lastValue;
/*     */ 
/*     */       protected C computeNext() {
/* 333 */         while (merged.hasNext()) {
/* 334 */           Object next = merged.next();
...
/*     */ 
/*     */     public C firstKey() {
/* 233 */       SortedMap backing = backingRowMap();
/* 234 */       if (backing == null) {
...
/*     */ 
/*     */     public C lastKey() {
/* 241 */       SortedMap backing = backingRowMap();
/* 242 */       if (backing == null) {
 ...
 * Qualified Name:     com.newrelic.com.google.common.collect.TreeBasedTable
