...
/*     */   {
/*  41 */     ImmutableList.Builder axesBuilder = new ImmutableList.Builder(lists.size());
/*     */ 
/*  43 */     for (List list : lists) {
/*  44 */       List copy = ImmutableList.copyOf(list);
/*  45 */       if (copy.isEmpty()) {
...
/*  87 */         return ((List)CartesianList.this.axes.get(axis)).get(axisIndex);
/*     */       }
/*     */ 
 ...
 * Qualified Name:     com.newrelic.com.google.common.collect.CartesianList
