...
/*     */   {
/*  73 */     Object[] result = newArray(type, first.length + second.length);
...
/*     */   {
/*  89 */     Object[] result = newArray(array, array.length + 1);
/*  90 */     result[0] = element;
...
/*     */   {
/* 105 */     Object[] result = arraysCopyOf(array, array.length + 1);
...
/*     */   {
/* 112 */     Object[] copy = newArray(original, newLength);
...
/* 209 */     int i = 0;
/* 210 */     for (Iterator i$ = elements.iterator(); i$.hasNext(); ) { Object element = i$.next();
/* 211 */       array[(i++)] = element;
/*     */     }
/* 213 */     return array;
/*     */   }
 ...
 * Qualified Name:     com.newrelic.com.google.common.collect.ObjectArrays
