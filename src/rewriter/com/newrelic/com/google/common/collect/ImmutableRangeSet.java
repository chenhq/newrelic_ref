...
/*  95 */       ImmutableRangeSet immutableRangeSet = (ImmutableRangeSet)rangeSet;
...
/*     */ 
/* 133 */     if (index != -1) {
/* 134 */       Range range = (Range)this.ranges.get(index);
...
/*     */   {
/* 242 */     ImmutableRangeSet result = this.complement;
/* 243 */     if (result != null)
/* 244 */       return result;
...
/*     */     }
/* 250 */     ImmutableList complementRanges = new ComplementRanges();
...
/*     */     }
/* 352 */     Range span = span().canonical(domain);
...
/* 563 */         for (Range currentRange : this.rangeSet.asRanges()) {
...
/*     */     {
/* 579 */       for (Range range : ranges.asRanges()) {
/* 580 */         add(range);
/*     */       }
/* 582 */       return this;
/*     */     }
...
/* 384 */       if (result == null) {
/* 385 */         long total = 0L;
/* 386 */         for (Range range : ImmutableRangeSet.this.ranges) {
...
/*     */     {
/* 399 */       return new AbstractIterator() {
...
/* 407 */               this.elemItr = ContiguousSet.create((Range)this.rangeItr.next(), ImmutableRangeSet.AsSet.this.domain).iterator();
/*     */             else {
...
/*     */     {
/* 420 */       return new AbstractIterator() {
...
/* 428 */               this.elemItr = ContiguousSet.create((Range)this.rangeItr.next(), ImmutableRangeSet.AsSet.this.domain).descendingIterator();
/*     */             else {
...
/*     */       try
/*     */       {
/* 470 */         Comparable c = (Comparable)o;
/* 471 */         return ImmutableRangeSet.this.contains(c); } catch (ClassCastException e) {
/*     */       }
/* 473 */       return false;
/*     */     }
/*     */ 
...
/*     */       {
/* 481 */         Comparable c = (Comparable)target;
/* 482 */         long total = 0L;
/* 483 */         for (Range range : ImmutableRangeSet.this.ranges) {
...
/*     */     Object writeReplace()
/*     */     {
/* 507 */       return new ImmutableRangeSet.AsSetSerializedForm(ImmutableRangeSet.this.ranges, this.domain);
/*     */     }
/*     */   }
/*     */ 
 ...
 * Qualified Name:     com.newrelic.com.google.common.collect.ImmutableRangeSet
