...
/*     */     }
/* 131 */     Object oldValue = this.delegate.put(key, value);
...
/* 149 */     Object oldValue = this.delegate.remove(key);
...
/* 286 */       final Iterator iterator = this.esDelegate.iterator();
...
/* 295 */           this.entry = ((Map.Entry)iterator.next());
/* 296 */           final Map.Entry finalEntry = this.entry;
/*     */ 
/* 298 */           return new ForwardingMapEntry() {
...
/*     */ 
/* 312 */               Object oldValue = finalEntry.setValue(value);
...
/* 323 */           Object value = this.entry.getValue();
/* 324 */           iterator.remove();
 ...
 * Qualified Name:     com.newrelic.com.google.common.collect.AbstractBiMap
