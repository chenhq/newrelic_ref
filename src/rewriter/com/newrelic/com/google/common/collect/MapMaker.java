...
/*     */       try {
/* 855 */         return this.computingFunction.apply(key);
...
/* 782 */       MapMaker.RemovalNotification notification = new MapMaker.RemovalNotification(key, value, this.removalCause);
/*     */ 
 ...
 * Qualified Name:     com.newrelic.com.google.common.collect.MapMaker
