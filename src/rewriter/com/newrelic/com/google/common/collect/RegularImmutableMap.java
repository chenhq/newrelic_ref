...
/*     */     {
/*  60 */       ImmutableMapEntry.TerminalEntry entry = theEntries[entryIndex];
/*  61 */       Object key = entry.getKey();
/*  62 */       int tableIndex = Hashing.smear(key.hashCode()) & this.mask;
/*  63 */       ImmutableMapEntry existing = this.table[tableIndex];
/*     */ 
/*  65 */       ImmutableMapEntry newEntry = existing == null ? entry : new NonTerminalMapEntry(entry, existing);
/*     */ 
...
/*  90 */       ImmutableMapEntry existing = this.table[tableIndex];
/*     */ 
/*  92 */       ImmutableMapEntry newEntry = existing == null ? new ImmutableMapEntry.TerminalEntry(key, value) : new NonTerminalMapEntry(key, value, existing);
/*     */ 
...
/* 156 */     for (ImmutableMapEntry entry = this.table[index]; 
/* 157 */       entry != null; 
/* 158 */       entry = entry.getNextInKeyBucket()) {
/* 159 */       Object candidateKey = entry.getKey();
/*     */ 
 ...
 * Qualified Name:     com.newrelic.com.google.common.collect.RegularImmutableMap
