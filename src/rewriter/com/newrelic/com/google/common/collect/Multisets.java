...
/*      */   {
/*   92 */     return (Multiset)Preconditions.checkNotNull(multiset);
/*      */   }
/*      */ 
/*      */   @Beta
...
/*      */   {
/*  212 */     return new ImmutableEntry(e, n);
/*      */   }
/*      */ 
/*      */   @Beta
...
/*      */     {
/*  270 */       FilteredMultiset filtered = (FilteredMultiset)unfiltered;
/*  271 */       Predicate combinedPredicate = Predicates.and(filtered.predicate, predicate);
/*      */ 
...
/*      */ 
/*  385 */     return new AbstractMultiset()
/*      */     {
...
/*      */       {
/*  408 */         final Iterator iterator1 = this.val$multiset1.entrySet().iterator();
/*      */ 
/*  410 */         final Iterator iterator2 = multiset2.entrySet().iterator();
/*      */ 
/*  413 */         return new AbstractIterator()
/*      */         {
/*      */           protected Multiset.Entry<E> computeNext() {
/*  416 */             if (iterator1.hasNext()) {
/*  417 */               Multiset.Entry entry1 = (Multiset.Entry)iterator1.next();
/*  418 */               Object element = entry1.getElement();
...
/*  423 */               Multiset.Entry entry2 = (Multiset.Entry)iterator2.next();
/*  424 */               Object element = entry2.getElement();
...
/*      */ 
/*  460 */     return new AbstractMultiset()
/*      */     {
/*      */       public int count(Object element) {
...
/*      */       Iterator<Multiset.Entry<E>> entryIterator()
/*      */       {
/*  475 */         final Iterator iterator1 = this.val$multiset1.entrySet().iterator();
/*      */ 
/*  477 */         return new AbstractIterator()
/*      */         {
/*      */           protected Multiset.Entry<E> computeNext() {
/*  480 */             while (iterator1.hasNext()) {
/*  481 */               Multiset.Entry entry1 = (Multiset.Entry)iterator1.next();
/*  482 */               Object element = entry1.getElement();
...
/*      */ 
/*  522 */     return new AbstractMultiset()
/*      */     {
/*      */       public boolean contains(@Nullable Object element) {
...
/*      */       Iterator<Multiset.Entry<E>> entryIterator()
/*      */       {
/*  550 */         final Iterator iterator1 = this.val$multiset1.entrySet().iterator();
/*      */ 
/*  552 */         final Iterator iterator2 = multiset2.entrySet().iterator();
/*      */ 
/*  554 */         return new AbstractIterator()
/*      */         {
/*      */           protected Multiset.Entry<E> computeNext() {
/*  557 */             if (iterator1.hasNext()) {
/*  558 */               Multiset.Entry entry1 = (Multiset.Entry)iterator1.next();
/*  559 */               Object element = entry1.getElement();
...
/*  564 */               Multiset.Entry entry2 = (Multiset.Entry)iterator2.next();
/*  565 */               Object element = entry2.getElement();
...
/*      */ 
/*  604 */     return new AbstractMultiset()
/*      */     {
...
/*      */       Iterator<Multiset.Entry<E>> entryIterator()
/*      */       {
/*  614 */         final Iterator iterator1 = this.val$multiset1.entrySet().iterator();
/*  615 */         return new AbstractIterator()
/*      */         {
/*      */           protected Multiset.Entry<E> computeNext() {
/*  618 */             while (iterator1.hasNext()) {
/*  619 */               Multiset.Entry entry1 = (Multiset.Entry)iterator1.next();
/*  620 */               Object element = entry1.getElement();
...
/*      */ 
/*  689 */     Iterator entryIterator = multisetToModify.entrySet().iterator();
/*  690 */     boolean changed = false;
/*  691 */     while (entryIterator.hasNext()) {
/*  692 */       Multiset.Entry entry = (Multiset.Entry)entryIterator.next();
...
/*  743 */     Iterator entryIterator = multisetToModify.entrySet().iterator();
/*  744 */     while (entryIterator.hasNext()) {
/*  745 */       Multiset.Entry entry = (Multiset.Entry)entryIterator.next();
...
/*  837 */       Multiset that = cast(elements);
/*  838 */       for (Multiset.Entry entry : that.entrySet())
...
/*      */   {
/* 1078 */     List sortedEntries = DECREASING_COUNT_ORDERING.immutableSortedCopy(multiset.entrySet());
/*      */ 
...
/*  974 */         if (entryCount != 0)
/*      */         {
/*  977 */           Multiset multiset = multiset();
...
/*  924 */       return new TransformedIterator(multiset().entrySet().iterator())
/*      */       {
...
/*      */     {
/*  299 */       return Sets.filter(this.unfiltered.entrySet(), new Predicate()
/*      */       {
 ...
 * Qualified Name:     com.newrelic.com.google.common.collect.Multisets
