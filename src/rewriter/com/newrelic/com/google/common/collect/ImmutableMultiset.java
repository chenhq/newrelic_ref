...
/*     */     {
/* 176 */       ImmutableMultiset result = (ImmutableMultiset)elements;
/* 177 */       if (!result.isPartialView()) {
/* 178 */         return result;
/*     */       }
/*     */     }
/*     */ 
/* 182 */     Multiset multiset = (elements instanceof Multiset) ? Multisets.cast(elements) : LinkedHashMultiset.create(elements);
/*     */ 
...
/*     */   {
/* 200 */     long size = 0L;
/* 201 */     ImmutableMap.Builder builder = ImmutableMap.builder();
/* 202 */     for (Multiset.Entry entry : entries) {
...
/*     */   {
/* 231 */     Multiset multiset = LinkedHashMultiset.create();
...
/*     */   {
/* 239 */     final Iterator entryIterator = entrySet().iterator();
...
/*     */   {
/* 323 */     for (Multiset.Entry entry : entrySet()) {
...
/* 571 */         Multiset multiset = Multisets.cast(elements);
/* 572 */         for (Multiset.Entry entry : multiset.entrySet())
...
/*     */ 
/*     */     Object readResolve() {
/* 444 */       LinkedHashMultiset multiset = LinkedHashMultiset.create(this.elements.length);
/*     */ 
 ...
 * Qualified Name:     com.newrelic.com.google.common.collect.ImmutableMultiset
