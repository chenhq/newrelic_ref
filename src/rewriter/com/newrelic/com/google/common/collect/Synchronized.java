...
/*      */   {
/* 1347 */     return new SynchronizedNavigableMap(navigableMap, mutex);
/*      */   }
/*      */ 
...
/*      */ 
/*      */   @GwtIncompatible("works but is needed only for NavigableMap")
/*      */   private static class SynchronizedEntry<K, V> extends Synchronized.SynchronizedObject
...
/*      */     {
/* 1532 */       return (Map.Entry)super.delegate();
/*      */     }
/*      */ 
...
/*      */   @GwtIncompatible("NavigableMap")
/*      */   @VisibleForTesting
/*      */   static class SynchronizedNavigableMap<K, V> extends Synchronized.SynchronizedSortedMap<K, V>
...
/*      */   @GwtIncompatible("NavigableSet")
/*      */   @VisibleForTesting
/*      */   static class SynchronizedNavigableSet<E> extends Synchronized.SynchronizedSortedSet<E>
...
/* 1251 */           NavigableSet dS = Synchronized.navigableSet(delegate().descendingSet(), this.mutex);
/*      */ 
...
/* 1216 */           return Synchronized.typePreservingCollection((Collection)super.next(), Synchronized.SynchronizedAsMapValues.this.mutex);
/*      */         }
/*      */       };
/*      */     }
/*      */   }
...
/* 1167 */         Collection collection = (Collection)super.get(key);
...
/*  855 */           final Map.Entry entry = (Map.Entry)super.next();
...
/*      */     }
/*      */ 
/*  876 */     public <T> T[] toArray(T[] array) { synchronized (this.mutex) {
...
/*      */     }
/*      */ 
/*  886 */     public boolean containsAll(Collection<?> c) { synchronized (this.mutex) {
...
/*      */     }
/*      */ 
/*  899 */     public boolean remove(Object o) { synchronized (this.mutex) {
...
/*      */     }
/*      */ 
/*  909 */     public boolean retainAll(Collection<?> c) { synchronized (this.mutex) {
...
/*  789 */       return (SortedSetMultimap)super.delegate();
/*      */     }
...
/*      */     }
/*      */ 
/*  797 */     public SortedSet<V> removeAll(Object key) { synchronized (this.mutex) {
...
/*  745 */       return (SetMultimap)super.delegate();
/*      */     }
...
/*      */     }
/*      */ 
/*  753 */     public Set<V> removeAll(Object key) { synchronized (this.mutex) {
...
/*      */     }
/*      */ 
/*  764 */     public Set<Map.Entry<K, V>> entries() { synchronized (this.mutex) {
...
/*  706 */       return (ListMultimap)super.delegate();
/*      */     }
...
/*      */     }
/*      */ 
/*  714 */     public List<V> removeAll(Object key) { synchronized (this.mutex) {
 ...
 * Qualified Name:     com.newrelic.com.google.common.collect.Synchronized
