...
/*     */     {
/* 253 */       ImmutableList list = ((ImmutableCollection)elements).asList();
...
/* 269 */       return of();
/*     */     }
/* 271 */     Object first = elements.next();
...
/* 322 */       return of();
/*     */     case 1:
/* 325 */       ImmutableList list = new SingletonImmutableList(elements[0]);
/* 326 */       return list;
/*     */     }
...
/* 348 */     return new AbstractIndexedListIterator(size(), index)
/*     */     {
 ...
 * Qualified Name:     com.newrelic.com.google.common.collect.ImmutableList
