...
/*     */   {
/* 106 */     TreeMultiset multiset = create();
...
/*     */   {
/* 162 */     AvlNode root = (AvlNode)this.rootReference.get();
...
/* 180 */     if (cmp == 0) {
/* 181 */       switch (4.$SwitchMap$com$google$common$collect$BoundType[this.range.getLowerBoundType().ordinal()]) {
/*     */       case 1:
...
/* 202 */     if (cmp == 0) {
/* 203 */       switch (4.$SwitchMap$com$google$common$collect$BoundType[this.range.getUpperBoundType().ordinal()]) {
/*     */       case 1:
...
/*     */     try
/*     */     {
/* 231 */       Object e = element;
/* 232 */       AvlNode root = (AvlNode)this.rootReference.get();
/* 233 */       if ((!this.range.contains(e)) || (root == null)) {
/* 234 */         return 0;
/*     */       }
/* 236 */       return root.count(comparator(), e);
/*     */     } catch (ClassCastException e) {
/* 238 */       return 0; } catch (NullPointerException e) {
/*     */     }
/* 240 */     return 0;
/*     */   }
/*     */ 
...
/* 251 */     AvlNode root = (AvlNode)this.rootReference.get();
/* 252 */     if (root == null) {
/* 253 */       comparator().compare(element, element);
/* 254 */       AvlNode newRoot = new AvlNode(element, occurrences);
/* 255 */       successor(this.header, newRoot, this.header);
/* 256 */       this.rootReference.checkAndSet(root, newRoot);
/* 257 */       return 0;
/*     */     }
/* 259 */     int[] result = new int[1];
/* 260 */     AvlNode newRoot = root.add(comparator(), element, occurrences, result);
...
/* 271 */     }AvlNode root = (AvlNode)this.rootReference.get();
/* 272 */     int[] result = new int[1];
/*     */     AvlNode newRoot;
/*     */     try {
/* 276 */       Object e = element;
...
/*     */     }
/*     */ 
/* 298 */     AvlNode root = (AvlNode)this.rootReference.get();
/* 299 */     if (root == null) {
/* 300 */       if (count > 0) {
...
/* 306 */     AvlNode newRoot = root.setCount(comparator(), element, count, result);
...
/*     */ 
/* 317 */     AvlNode root = (AvlNode)this.rootReference.get();
/* 318 */     if (root == null) {
/* 319 */       if (oldCount == 0) {
/* 320 */         if (newCount > 0) {
...
/* 329 */     AvlNode newRoot = root.setCount(comparator(), element, oldCount, newCount, result);
...
/* 335 */     return new Multisets.AbstractEntry()
/*     */     {
/*     */       public E getElement() {
...
/*     */   {
/* 357 */     AvlNode root = (AvlNode)this.rootReference.get();
/* 358 */     if (root == null)
/* 359 */       return null;
/*     */     AvlNode node;
/* 362 */     if (this.range.hasLowerBound()) {
/* 363 */       Object endpoint = this.range.getLowerEndpoint();
/* 364 */       AvlNode node = ((AvlNode)this.rootReference.get()).ceiling(comparator(), endpoint);
/* 365 */       if (node == null) {
/* 366 */         return null;
/*     */       }
...
/* 379 */     AvlNode root = (AvlNode)this.rootReference.get();
/* 380 */     if (root == null)
/* 381 */       return null;
/*     */     AvlNode node;
/* 384 */     if (this.range.hasUpperBound()) {
/* 385 */       Object endpoint = this.range.getUpperEndpoint();
/* 386 */       AvlNode node = ((AvlNode)this.rootReference.get()).floor(comparator(), endpoint);
/* 387 */       if (node == null) {
/* 388 */         return null;
/*     */       }
...
/*     */         }
/* 423 */         Multiset.Entry result = TreeMultiset.this.wrapEntry(this.current);
...
/*     */         }
/* 465 */         Multiset.Entry result = TreeMultiset.this.wrapEntry(this.current);
...
/*     */ 
/* 969 */     Comparator comparator = (Comparator)stream.readObject();
...
/*     */ 
/* 977 */     AvlNode header = new AvlNode(null, 1);
...
/* 579 */       if (cmp < 0) {
/* 580 */         AvlNode initLeft = this.left;
...
/* 593 */       }if (cmp > 0) {
/* 594 */         AvlNode initRight = this.right;
...
/* 620 */       if (cmp < 0) {
/* 621 */         AvlNode initLeft = this.left;
...
/* 638 */       }if (cmp > 0) {
/* 639 */         AvlNode initRight = this.right;
...
/* 671 */       if (cmp < 0) {
/* 672 */         AvlNode initLeft = this.left;
...
/* 688 */       }if (cmp > 0) {
/* 689 */         AvlNode initRight = this.right;
...
/* 724 */       if (cmp < 0) {
/* 725 */         AvlNode initLeft = this.left;
...
/* 745 */       }if (cmp > 0) {
/* 746 */         AvlNode initRight = this.right;
 ...
 * Qualified Name:     com.newrelic.com.google.common.collect.TreeMultiset
