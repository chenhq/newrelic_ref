...
/*  87 */     return new AbstractSequentialIterator(last()) {
...
/* 115 */     return distance >= 2147483647L ? 2147483647 : (int)distance + 1;
/*     */   }
/*     */ 
...
/*     */     try
/*     */     {
/* 123 */       return this.range.contains((Comparable)object); } catch (ClassCastException e) {
/*     */     }
/* 125 */     return false;
/*     */   }
/*     */ 
...
/* 141 */       return other;
/*     */     }
/* 143 */     Comparable lowerEndpoint = (Comparable)Ordering.natural().max(first(), other.first());
/* 144 */     Comparable upperEndpoint = (Comparable)Ordering.natural().min(last(), other.last());
 ...
 * Qualified Name:     com.newrelic.com.google.common.collect.RegularContiguousSet
