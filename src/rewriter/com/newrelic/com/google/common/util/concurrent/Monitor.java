...
/*      */     try
/*      */     {
/*  383 */       return lock.tryLock(timeoutNanos, TimeUnit.NANOSECONDS); } catch (InterruptedException interrupt) {
/*      */       while (true) {
...
/*      */       try
/*      */       {
/*  541 */         boolean bool2 = satisfied = (guard.isSatisfied()) || (awaitNanos(guard, timeoutNanos, signalBeforeWaiting)) ? 1 : 0;
/*      */ 
/*  550 */         if (!satisfied) {
/*  551 */           lock.unlock();
/*      */         }
...
/*      */     try
/*      */     {
/*  744 */       return awaitNanos(guard, timeoutNanos, signalBeforeWaiting); } catch (InterruptedException interrupt) {
/*      */       while (true) {
 ...
 * Qualified Name:     com.newrelic.com.google.common.util.concurrent.Monitor
