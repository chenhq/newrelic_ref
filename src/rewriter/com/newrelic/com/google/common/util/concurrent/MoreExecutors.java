...
/* 612 */     List futures = Lists.newArrayListWithCapacity(ntasks);
/* 613 */     BlockingQueue futureQueue = Queues.newLinkedBlockingQueue();
/*     */     try
/*     */     {
/* 624 */       ExecutionException ee = null;
/* 625 */       long lastTime = timed ? System.nanoTime() : 0L;
/* 626 */       Iterator it = tasks.iterator();
/*     */ 
...
/*     */       while (true)
/*     */       {
/* 633 */         Future f = (Future)futureQueue.poll();
/* 634 */         if (f == null)
/* 635 */           if (ntasks > 0) {
/* 636 */             ntasks--;
...
/*     */   {
/* 682 */     final ListenableFuture future = executorService.submit(task);
/* 683 */     future.addListener(new Runnable() {
/*     */       public void run() {
/* 685 */         this.val$queue.add(future);
/*     */       }
/*     */     }
/*     */     , sameThreadExecutor());
/*     */ 
...
/*     */     {
/* 501 */       ListenableFutureTask task = ListenableFutureTask.create(command, null);
/*     */ 
...
/*     */     {
/* 510 */       ListenableFutureTask task = ListenableFutureTask.create(callable);
 ...
 * Qualified Name:     com.newrelic.com.google.common.util.concurrent.MoreExecutors
