...
/*      */ 
/*  301 */     Map lockGraphNodes = getOrCreateNodes(enumClass);
/*      */ 
...
/*      */   {
/*  308 */     Map existing = (Map)lockGraphNodesPerType.get(clazz);
/*      */ 
/*  310 */     if (existing != null) {
/*  311 */       return existing;
/*      */     }
/*  313 */     Map created = createNodes(clazz);
...
/*      */   {
/*  326 */     EnumMap map = Maps.newEnumMap(clazz);
/*  327 */     Enum[] keys = (Enum[])clazz.getEnumConstants();
/*  328 */     int numKeys = keys.length;
/*  329 */     ArrayList nodes = Lists.newArrayListWithCapacity(numKeys);
/*      */ 
/*  332 */     for (Enum key : keys) {
...
/*  762 */       ArrayList acquiredLockList = (ArrayList)acquiredLocks.get();
...
/*  777 */       ArrayList acquiredLockList = (ArrayList)acquiredLocks.get();
...
/*      */     {
/*  880 */       super();
/*  881 */       this.readLock = new CycleDetectingLockFactory.CycleDetectingReentrantReadLock(CycleDetectingLockFactory.this, this);
/*  882 */       this.writeLock = new CycleDetectingLockFactory.CycleDetectingReentrantWriteLock(CycleDetectingLockFactory.this, this);
...
/*      */       }
/*      */ 
/*  693 */       Set seen = Sets.newIdentityHashSet();
...
/*      */       }
/*      */ 
/*  738 */       for (Map.Entry entry : this.allowedPriorLocks.entrySet()) {
...
/*      */     {
/*  449 */       return this.policy == CycleDetectingLockFactory.Policies.DISABLED ? new ReentrantLock(fair) : new CycleDetectingLockFactory.CycleDetectingReentrantLock(this, (CycleDetectingLockFactory.LockGraphNode)this.lockGraphNodes.get(rank), fair, null);
/*      */     }
/*      */ 
...
/*      */     {
/*  471 */       return this.policy == CycleDetectingLockFactory.Policies.DISABLED ? new ReentrantReadWriteLock(fair) : new CycleDetectingLockFactory.CycleDetectingReentrantReadWriteLock(this, (CycleDetectingLockFactory.LockGraphNode)this.lockGraphNodes.get(rank), fair, null);
/*      */     }
/*      */   }
/*      */ 
/*      */   @Beta
 ...
 * Qualified Name:     com.newrelic.com.google.common.util.concurrent.CycleDetectingLockFactory
