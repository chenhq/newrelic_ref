...
/*     */   {
/* 289 */     double maxBurstSeconds = unit.toNanos(maxBurstBuildup) / 1000000000.0D;
...
/* 650 */       if (oldMaxPermits == (1.0D / 0.0D))
/*     */       {
/* 652 */         this.storedPermits = 0.0D;
/*     */       }
/* 654 */       else this.storedPermits = (oldMaxPermits == 0.0D ? this.maxPermits : this.storedPermits * this.maxPermits / oldMaxPermits);
/*     */     }
/*     */ 
/*     */     long storedPermitsToWaitTime(double storedPermits, double permitsToTake)
/*     */     {
 ...
 * Qualified Name:     com.newrelic.com.google.common.util.concurrent.RateLimiter
