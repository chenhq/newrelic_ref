...
/*     */ import com.newrelic.com.google.common.collect.ImmutableListMultimap.Builder;
...
/* 375 */     return Maps.transformValues(this.parameters.asMap(), new Function()
/*     */     {
...
/*     */   {
/* 392 */     ImmutableSet charsetValues = ImmutableSet.copyOf(this.parameters.get("charset"));
...
/* 432 */     ImmutableListMultimap.Builder builder = ImmutableListMultimap.builder();
/* 433 */     for (Map.Entry entry : this.parameters.entries()) {
...
/*     */   {
/* 491 */     return ((mediaTypeRange.type.equals("*")) || (mediaTypeRange.type.equals(this.type))) && ((mediaTypeRange.subtype.equals("*")) || (mediaTypeRange.subtype.equals(this.subtype))) && (this.parameters.entries().containsAll(mediaTypeRange.parameters.entries()));
/*     */   }
/*     */ 
/*     */   public static MediaType create(String type, String subtype)
/*     */   {
/* 503 */     return create(type, subtype, ImmutableListMultimap.of());
/*     */   }
/*     */ 
...
/*     */ 
/* 560 */     ImmutableListMultimap.Builder builder = ImmutableListMultimap.builder();
/* 561 */     for (Map.Entry entry : parameters.entries()) {
...
/* 591 */       ImmutableListMultimap.Builder parameters = ImmutableListMultimap.builder();
...
/*     */             }
/*     */           }
/* 609 */           String value = valueBuilder.toString();
...
/* 696 */       builder.append("; ");
/* 697 */       Multimap quotedParameters = Multimaps.transformValues(this.parameters, new Function()
/*     */       {
 ...
 * Qualified Name:     com.newrelic.com.google.common.net.MediaType
