...
/*      */     try {
/*  841 */       InputStream in = (InputStream)closer.register((Closeable)supplier.getInput());
...
/*  975 */     Iterable sources = Iterables.transform(suppliers, new Function()
/*      */     {
...
/* 1020 */         return (InputStream)this.val$supplier.getInput();
/*      */       }
/*      */ 
/*      */       public String toString()
/*      */       {
/* 1025 */         return "ByteStreams.asByteSource(" + this.val$supplier + ")";
/*      */       }
/*      */     };
/*      */   }
/*      */ 
...
/* 1050 */         return (OutputStream)this.val$supplier.getOutput();
/*      */       }
/*      */ 
/*      */       public String toString()
/*      */       {
/* 1055 */         return "ByteStreams.asByteSink(" + this.val$supplier + ")";
/*      */       }
/*      */     };
/*      */   }
/*      */ 
...
/*      */   {
/* 1063 */     return (InputSupplier)Preconditions.checkNotNull(source);
/*      */   }
/*      */ 
/*      */   static <S extends OutputStream> OutputSupplier<S> asOutputSupplier(ByteSink sink)
/*      */   {
/* 1069 */     return (OutputSupplier)Preconditions.checkNotNull(sink);
/*      */   }
/*      */ 
 ...
 * Qualified Name:     com.newrelic.com.google.common.io.ByteStreams
