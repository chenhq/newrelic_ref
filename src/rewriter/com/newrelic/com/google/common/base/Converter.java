...
/*     */           public B next()
/*     */           {
/* 192 */             return Converter.this.convert(this.fromIterator.next());
/*     */           }
/*     */ 
/*     */           public void remove()
/*     */           {
...
/*     */   {
/* 212 */     Converter result = this.reverse;
...
/*     */   {
/* 398 */     return new FunctionBasedConverter(forwardFunction, backwardFunction, null);
/*     */   }
/*     */ 
...
/*     */     {
/* 476 */       return (Converter)Preconditions.checkNotNull(otherConverter, "otherConverter");
/*     */     }
/*     */ 
 ...
 * Qualified Name:     com.newrelic.com.google.common.base.Converter
