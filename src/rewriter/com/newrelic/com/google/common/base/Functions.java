...
/*     */   {
/* 155 */     return new ForMapWithDefault(map, defaultValue);
/*     */   }
/*     */ 
/*     */   public static <A, B, C> Function<A, C> compose(Function<B, C> g, Function<A, ? extends B> f)
/*     */   {
/* 202 */     return new FunctionComposition(g, f);
/*     */   }
/*     */ 
...
/*     */     {
/* 169 */       Object result = this.map.get(key);
...
/*     */     {
/* 115 */       this.map = ((Map)Preconditions.checkNotNull(map));
/*     */     }
/*     */ 
/*     */     public V apply(@Nullable K key)
/*     */     {
/* 120 */       Object result = this.map.get(key);
 ...
 * Qualified Name:     com.newrelic.com.google.common.base.Functions
