...
/* 280 */     return UnsignedBytes.LexicographicalComparatorHolder.PureJavaComparator.INSTANCE;
/*     */   }
/*     */ 
/*     */   @VisibleForTesting
...
/*     */           try {
/* 351 */             return (Unsafe)AccessController.doPrivileged(new PrivilegedExceptionAction()
/*     */             {
/*     */               public Unsafe run() throws Exception {
/* 354 */                 Class k = Unsafe.class;
...
/*     */       static
/*     */       {
/* 301 */         BIG_ENDIAN = ByteOrder.nativeOrder().equals(ByteOrder.BIG_ENDIAN);
/*     */ 
/* 329 */         theUnsafe = getUnsafe();
/*     */ 
/* 331 */         BYTE_ARRAY_BASE_OFFSET = theUnsafe.arrayBaseOffset([B.class);
/*     */ 
/* 334 */         if (theUnsafe.arrayIndexScale([B.class) != 1)
 ...
 * Qualified Name:     com.newrelic.com.google.common.primitives.UnsignedBytes
