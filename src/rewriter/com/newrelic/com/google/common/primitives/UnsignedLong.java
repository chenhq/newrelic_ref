...
/*     */   {
/* 201 */     float fValue = (float)(this.value & 0xFFFFFFFF);
/* 202 */     if (this.value < 0L) {
/* 203 */       fValue += 9.223372E+18F;
/*     */     }
/* 205 */     return fValue;
/*     */   }
/*     */ 
...
/*     */   {
/* 215 */     double dValue = this.value & 0xFFFFFFFF;
/* 216 */     if (this.value < 0L) {
/* 217 */       dValue += 9.223372036854776E+18D;
/*     */     }
/* 219 */     return dValue;
/*     */   }
/*     */ 
...
/*     */   {
/* 226 */     BigInteger bigInt = BigInteger.valueOf(this.value & 0xFFFFFFFF);
 ...
 * Qualified Name:     com.newrelic.com.google.common.primitives.UnsignedLong
