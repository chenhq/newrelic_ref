...
/*     */   {
/* 103 */     return ((1.0F / -1.0F) < value ? 1 : 0) & (value < (1.0F / 1.0F) ? 1 : 0);
/*     */   }
/*     */ 
...
/*     */     }
/*     */ 
/* 172 */     label65: for (int i = 0; i < array.length - target.length + 1; i++) {
 ...
 * Qualified Name:     com.newrelic.com.google.common.primitives.Floats
