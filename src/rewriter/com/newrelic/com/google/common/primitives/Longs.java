...
/*     */     }
/*     */ 
/* 158 */     label65: for (int i = 0; i < array.length - target.length + 1; i++) {
...
/*     */       }
/* 355 */       accum *= 10L;
/* 356 */       if (accum < -9223372036854775808L + digit) {
/* 357 */         return null;
/*     */       }
/* 359 */       accum -= digit;
/*     */     }
...
/* 364 */     if (accum == -9223372036854775808L) {
/* 365 */       return null;
/*     */     }
 ...
 * Qualified Name:     com.newrelic.com.google.common.primitives.Longs
