...
/* 280 */         retVal |= (this.bytes[i] & 0xFF) << i * 8;
/*     */       }
/* 282 */       return retVal;
/*     */     }
/*     */ 
...
/*     */     public byte[] asBytes()
/*     */     {
/* 187 */       return new byte[] { (byte)(int)this.hash, (byte)(int)(this.hash >> 8), (byte)(int)(this.hash >> 16), (byte)(int)(this.hash >> 24), (byte)(int)(this.hash >> 32), (byte)(int)(this.hash >> 40), (byte)(int)(this.hash >> 48), (byte)(int)(this.hash >> 56) };
/*     */     }
/*     */ 
/*     */     public int asInt()
/*     */     {
 ...
 * Qualified Name:     com.newrelic.com.google.common.hash.HashCode
