...
public class ClassReader
{
  ...
  void a(ClassWriter paramClassWriter)
  {
    ...
    int i = readUnsignedShort(this.header + 2);
    String str1 = readUTF8(this.a[i], arrayOfChar);
    localHashMap1.put(str1, new Integer(i));
    int j = readUnsignedShort(this.header + 4);
    String str2;
    if (j > 0)
    {
      str2 = readUTF8(this.a[j], arrayOfChar);
      localHashMap1.put(str2, new Integer(j));
    }
    else
    {
      str2 = null;
    ...
    for (int m = 1; m < k; m++)
    {
      ...
      case 6:
        ...
        break;
      case 7:
        String str3 = readUTF8(n, arrayOfChar);
        localObject = (Integer)localHashMap1.get(str3);
        if (localObject == null)
        {
          localObject = new Integer(m);
          localHashMap1.put(str3, localObject);
        }
        localHashMap2.put(new Integer(m), localObject);
      }
    }
    ...
    for (int n = 1; n < k; n++)
    {
      ...
      case 10:
      case 11:
        int i3 = this.a[readUnsignedShort(i1 + 2)];
        ((Item)localObject).a(i2, readClass(i1, arrayOfChar), readUTF8(i3, arrayOfChar), readUTF8(i3 + 2, arrayOfChar));
        Integer localInteger1 = new Integer(readUnsignedShort(i1));
        int i5 = ((Integer)localHashMap2.get(localInteger1)).intValue();
        paramClassWriter.d.putByte(i2);
        paramClassWriter.d.putShort(i5);
        paramClassWriter.d.putShort(readUnsignedShort(i1 + 2));
        break;
      case 3:
        ((Item)localObject).a(readInt(i1));
        paramClassWriter.d.putByte(i2);
        paramClassWriter.d.putInt(readInt(i1));
        break;
      case 4:
        ((Item)localObject).a(Float.intBitsToFloat(readInt(i1)));
        paramClassWriter.d.putByte(i2);
        paramClassWriter.d.putInt(readInt(i1));
        break;
      case 12:
        ((Item)localObject).a(i2, readUTF8(i1, arrayOfChar), readUTF8(i1 + 2, arrayOfChar), null);
        paramClassWriter.d.putByte(i2);
        paramClassWriter.d.putShort(readUnsignedShort(i1));
        paramClassWriter.d.putShort(readUnsignedShort(i1 + 2));
        break;
      case 5:
        ((Item)localObject).a(readLong(i1));
        paramClassWriter.d.putByte(i2);
        paramClassWriter.d.putLong(readLong(i1));
        n++;
        break;
      case 6:
        ((Item)localObject).a(Double.longBitsToDouble(readLong(i1)));
        paramClassWriter.d.putByte(i2);
        paramClassWriter.d.putLong(readLong(i1));
        n++;
        break;
      case 1:
        ...
        {
          i1 = this.a[n];
          str4 = this.c[n] =  = a(i1 + 2, readUnsignedShort(i1), arrayOfChar);
        }
        ((Item)localObject).a(i2, str4, null, null);
        paramClassWriter.d.putByte(i2);
        paramClassWriter.d.putUTF8(str4);
        break;
      case 2:
      case 7:
      case 8:
      default:
        str4 = readUTF8(i1, arrayOfChar);
        ((Item)localObject).a(i2, str4, null, null);
        paramClassWriter.d.b(i2, readUnsignedShort(i1));
        Integer localInteger2 = (Integer)localHashMap1.get(str4);
        if ((i2 == 7) && (n != localInteger2.intValue()))
          continue;
      }
    ...
    paramClassWriter.f = ((int)(0.75D * k));
    paramClassWriter.c = k;
  }
 ...
 * Qualified Name:     com.newrelic.objectweb.asm.ClassReader
