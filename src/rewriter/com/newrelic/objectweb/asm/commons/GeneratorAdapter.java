...
public class GeneratorAdapter extends LocalVariablesSorter
{
  ...
  public void ifCmp(Type paramType, int paramInt, Label paramLabel)
  {
    ...
    case 7:
      ...
      break;
    case 8:
      this.mv.visitInsn((paramInt == 156) || (paramInt == 157) ? 152 : 151);
      break;
    case 6:
      this.mv.visitInsn((paramInt == 156) || (paramInt == 157) ? 150 : 149);
      break;
    case 9:
    case 10:
      switch (paramInt)
  ...
  public void invokeDynamic(Method paramMethod)
  {
    invokeInsn(186, Type.getObjectType("java/lang/dyn/Dynamic"), paramMethod);
  }
 ...
 * Qualified Name:     com.newrelic.objectweb.asm.commons.GeneratorAdapter
