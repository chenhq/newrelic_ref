...
/*     */   }
/*     */ 
/*     */   public com.newrelic.org.dom4j.Document read(org.w3c.dom.Document domDocument) {
/*  74 */     if ((domDocument instanceof com.newrelic.org.dom4j.Document)) {
/*  75 */       return (com.newrelic.org.dom4j.Document)domDocument;
/*     */     }
/*     */ 
/*  78 */     com.newrelic.org.dom4j.Document document = createDocument();
/*     */ 
...
/*  94 */     com.newrelic.org.dom4j.Document document = null;
/*     */ 
/*  96 */     if ((current instanceof Element))
/*  97 */       element = (Element)current;
/*     */     else {
/*  99 */       document = (com.newrelic.org.dom4j.Document)current;
/*     */     }
/*     */ 
...
/*     */       }
/*     */       else {
/* 115 */         com.newrelic.org.dom4j.Document currentDoc = (com.newrelic.org.dom4j.Document)current;
...
/*     */       else {
/* 127 */         ((com.newrelic.org.dom4j.Document)current).addComment(node.getNodeValue());
/*     */       }
/*     */ 
/* 130 */       break;
/*     */     case 10:
 ...
 * Qualified Name:     com.newrelic.org.dom4j.io.DOMReader
