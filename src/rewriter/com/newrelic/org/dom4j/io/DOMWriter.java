...
/*     */ 
/*  38 */   private static final String[] DEFAULT_DOM_DOCUMENT_CLASSES = { "org.apache.xerces.dom.DocumentImpl", "gnu.xml.dom.DomDocument", "org.apache.crimson.tree.XmlDocument", "com.sun.xml.tree.XmlDocument", "oracle.xml.parser.v2.XMLDocument", "oracle.xml.parser.XMLDocument", "com.newrelic.org.dom4j.dom.DOMDocument" };
...
/*     */   }
/*     */ 
/*     */   public org.w3c.dom.Document write(com.newrelic.org.dom4j.Document document)
/*     */     throws DocumentException
/*     */   {
...
/*     */   }
/*     */ 
/*     */   public org.w3c.dom.Document write(com.newrelic.org.dom4j.Document document, DOMImplementation domImpl) throws DocumentException
/*     */   {
...
/*     */ 
/* 157 */       if ((object instanceof com.newrelic.org.dom4j.Element)) {
/* 158 */         appendDOMTree(domDocument, domCurrent, (com.newrelic.org.dom4j.Element)object);
/* 159 */       } else if ((object instanceof String)) {
/* 160 */         appendDOMTree(domDocument, domCurrent, (String)object);
/* 161 */       } else if ((object instanceof com.newrelic.org.dom4j.Text)) {
/* 162 */         com.newrelic.org.dom4j.Text text = (com.newrelic.org.dom4j.Text)object;
...
/* 166 */       } else if ((object instanceof com.newrelic.org.dom4j.Comment)) {
/* 167 */         appendDOMTree(domDocument, domCurrent, (com.newrelic.org.dom4j.Comment)object);
/* 168 */       } else if ((object instanceof Entity)) {
/* 169 */         appendDOMTree(domDocument, domCurrent, (Entity)object);
/* 170 */       } else if ((object instanceof com.newrelic.org.dom4j.ProcessingInstruction)) {
/* 171 */         appendDOMTree(domDocument, domCurrent, (com.newrelic.org.dom4j.ProcessingInstruction)object);
/*     */       }
/*     */     }
/*     */   }
/*     */ 
/*     */   protected void appendDOMTree(org.w3c.dom.Document domDocument, Node domCurrent, com.newrelic.org.dom4j.Element element)
/*     */   {
...
/*     */   }
/*     */ 
/*     */   protected void appendDOMTree(org.w3c.dom.Document domDocument, Node domCurrent, com.newrelic.org.dom4j.Comment comment)
/*     */   {
...
/*     */   }
/*     */ 
/*     */   protected void appendDOMTree(org.w3c.dom.Document domDoc, Node domCurrent, com.newrelic.org.dom4j.ProcessingInstruction pi)
/*     */   {
...
/*     */   }
/*     */ 
/*     */   protected org.w3c.dom.Document createDomDocument(com.newrelic.org.dom4j.Document document) throws DocumentException
/*     */   {
...
/*     */   }
/*     */ 
/*     */   protected org.w3c.dom.Document createDomDocument(com.newrelic.org.dom4j.Document document, DOMImplementation domImpl) throws DocumentException
/*     */   {
 ...
 * Qualified Name:     com.newrelic.org.dom4j.io.DOMWriter
