...
/* 179 */       break;
/*     */     case 2:
/* 182 */       writeAttribute((com.newrelic.org.dom4j.Attribute)n);
/*     */ 
/* 184 */       break;
/*     */     case 13:
/* 187 */       writeNamespace((com.newrelic.org.dom4j.Namespace)n);
/*     */ 
/* 189 */       break;
/*     */     case 8:
/* 192 */       writeComment((com.newrelic.org.dom4j.Comment)n);
/*     */ 
/* 194 */       break;
/*     */     case 4:
...
/* 199 */       break;
/*     */     case 7:
/* 202 */       writeProcessingInstruction((com.newrelic.org.dom4j.ProcessingInstruction)n);
/*     */ 
/* 204 */       break;
/*     */     case 5:
...
/*     */   }
/*     */ 
/*     */   public void writeAttribute(com.newrelic.org.dom4j.Attribute attr)
/*     */     throws XMLStreamException
/*     */   {
/* 307 */     this.consumer.add(createAttribute(attr));
/*     */   }
/*     */ 
/*     */   public javax.xml.stream.events.Attribute createAttribute(com.newrelic.org.dom4j.Attribute attr)
/*     */   {
...
/*     */   }
/*     */ 
/*     */   public void writeNamespace(com.newrelic.org.dom4j.Namespace ns)
/*     */     throws XMLStreamException
/*     */   {
/* 337 */     this.consumer.add(createNamespace(ns));
/*     */   }
/*     */ 
/*     */   public javax.xml.stream.events.Namespace createNamespace(com.newrelic.org.dom4j.Namespace ns)
/*     */   {
...
/*     */   }
/*     */ 
/*     */   public void writeComment(com.newrelic.org.dom4j.Comment comment)
/*     */     throws XMLStreamException
/*     */   {
/* 416 */     this.consumer.add(createComment(comment));
/*     */   }
/*     */ 
/*     */   public javax.xml.stream.events.Comment createComment(com.newrelic.org.dom4j.Comment comment)
/*     */   {
/* 429 */     return this.factory.createComment(comment.getText());
/*     */   }
/*     */ 
/*     */   public void writeProcessingInstruction(com.newrelic.org.dom4j.ProcessingInstruction pi)
/*     */     throws XMLStreamException
/*     */   {
/* 443 */     this.consumer.add(createProcessingInstruction(pi));
/*     */   }
/*     */ 
/*     */   public javax.xml.stream.events.ProcessingInstruction createProcessingInstruction(com.newrelic.org.dom4j.ProcessingInstruction pi)
/*     */   {
...
/*     */   }
/*     */ 
/*     */   public javax.xml.namespace.QName createQName(com.newrelic.org.dom4j.QName qname)
/*     */   {
...
/*     */ 
/*     */     public Object next() {
/* 637 */       com.newrelic.org.dom4j.Namespace ns = (com.newrelic.org.dom4j.Namespace)this.iter.next();
...
/*     */ 
/*     */     public Object next() {
/* 609 */       com.newrelic.org.dom4j.Attribute attr = (com.newrelic.org.dom4j.Attribute)this.iter.next();
 ...
 * Qualified Name:     com.newrelic.org.dom4j.io.STAXEventWriter
