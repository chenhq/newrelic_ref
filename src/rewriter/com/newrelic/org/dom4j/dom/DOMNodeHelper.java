...
/*     */ 
/*     */   public static boolean supports(com.newrelic.org.dom4j.Node node, String feature, String version)
/*     */   {
/*  41 */     return false;
/*     */   }
/*     */ 
/*     */   public static String getNamespaceURI(com.newrelic.org.dom4j.Node node) {
/*  45 */     return null;
/*     */   }
/*     */ 
/*     */   public static String getPrefix(com.newrelic.org.dom4j.Node node) {
/*  49 */     return null;
/*     */   }
/*     */ 
/*     */   public static String getLocalName(com.newrelic.org.dom4j.Node node) {
/*  53 */     return null;
/*     */   }
/*     */ 
/*     */   public static void setPrefix(com.newrelic.org.dom4j.Node node, String prefix) throws DOMException {
/*  57 */     notSupported();
/*     */   }
/*     */ 
/*     */   public static String getNodeValue(com.newrelic.org.dom4j.Node node) throws DOMException {
/*  61 */     return node.getText();
/*     */   }
/*     */ 
/*     */   public static void setNodeValue(com.newrelic.org.dom4j.Node node, String nodeValue) throws DOMException
/*     */   {
/*  66 */     node.setText(nodeValue);
/*     */   }
/*     */ 
/*     */   public static org.w3c.dom.Node getParentNode(com.newrelic.org.dom4j.Node node) {
/*  70 */     return asDOMNode(node.getParent());
/*     */   }
/*     */ 
/*     */   public static NodeList getChildNodes(com.newrelic.org.dom4j.Node node) {
/*  74 */     return EMPTY_NODE_LIST;
/*     */   }
/*     */ 
/*     */   public static org.w3c.dom.Node getFirstChild(com.newrelic.org.dom4j.Node node) {
/*  78 */     return null;
/*     */   }
/*     */ 
/*     */   public static org.w3c.dom.Node getLastChild(com.newrelic.org.dom4j.Node node) {
/*  82 */     return null;
/*     */   }
/*     */ 
/*     */   public static org.w3c.dom.Node getPreviousSibling(com.newrelic.org.dom4j.Node node) {
/*  86 */     com.newrelic.org.dom4j.Element parent = node.getParent();
/*     */ 
/*  88 */     if (parent != null) {
/*  89 */       int index = parent.indexOf(node);
/*     */ 
/*  91 */       if (index > 0) {
/*  92 */         com.newrelic.org.dom4j.Node previous = parent.node(index - 1);
/*     */ 
...
/*     */   }
/*     */ 
/*     */   public static org.w3c.dom.Node getNextSibling(com.newrelic.org.dom4j.Node node) {
/* 102 */     com.newrelic.org.dom4j.Element parent = node.getParent();
/*     */ 
/* 104 */     if (parent != null) {
...
/* 109 */           com.newrelic.org.dom4j.Node next = parent.node(index);
/*     */ 
...
/*     */   }
/*     */ 
/*     */   public static NamedNodeMap getAttributes(com.newrelic.org.dom4j.Node node) {
/* 120 */     return null;
/*     */   }
/*     */ 
/*     */   public static org.w3c.dom.Document getOwnerDocument(com.newrelic.org.dom4j.Node node) {
/* 124 */     return asDOMDocument(node.getDocument());
/*     */   }
/*     */ 
/*     */   public static org.w3c.dom.Node insertBefore(com.newrelic.org.dom4j.Node node, org.w3c.dom.Node newChild, org.w3c.dom.Node refChild)
/*     */     throws DOMException
/*     */   {
...
/*     */ 
/* 135 */       if (index < 0)
/* 136 */         branch.add((com.newrelic.org.dom4j.Node)newChild);
/*     */       else {
...
/*     */   }
/*     */ 
/*     */   public static org.w3c.dom.Node replaceChild(com.newrelic.org.dom4j.Node node, org.w3c.dom.Node newChild, org.w3c.dom.Node oldChild)
/*     */     throws DOMException
/*     */   {
...
/*     */   }
/*     */ 
/*     */   public static org.w3c.dom.Node removeChild(com.newrelic.org.dom4j.Node node, org.w3c.dom.Node oldChild)
/*     */     throws DOMException
/*     */   {
/* 173 */     if ((node instanceof Branch)) {
/* 174 */       Branch branch = (Branch)node;
/* 175 */       branch.remove((com.newrelic.org.dom4j.Node)oldChild);
/*     */ 
/* 177 */       return oldChild;
/*     */     }
/*     */ 
...
/*     */   }
/*     */ 
/*     */   public static org.w3c.dom.Node appendChild(com.newrelic.org.dom4j.Node node, org.w3c.dom.Node newChild)
/*     */     throws DOMException
/*     */   {
...
/*     */       }
/*     */ 
/* 194 */       branch.add((com.newrelic.org.dom4j.Node)newChild);
/*     */ 
/* 196 */       return newChild;
/*     */     }
/*     */ 
...
/*     */   }
/*     */ 
/*     */   public static boolean hasChildNodes(com.newrelic.org.dom4j.Node node)
/*     */   {
/* 204 */     return false;
/*     */   }
/*     */ 
/*     */   public static org.w3c.dom.Node cloneNode(com.newrelic.org.dom4j.Node node, boolean deep) {
/* 208 */     return asDOMNode((com.newrelic.org.dom4j.Node)node.clone());
/*     */   }
/*     */ 
/*     */   public static void normalize(com.newrelic.org.dom4j.Node node) {
/* 212 */     notSupported();
/*     */   }
/*     */ 
/*     */   public static boolean isSupported(com.newrelic.org.dom4j.Node n, String feature, String version) {
/* 216 */     return false;
/*     */   }
/*     */ 
/*     */   public static boolean hasAttributes(com.newrelic.org.dom4j.Node node) {
/* 220 */     if ((node != null) && ((node instanceof com.newrelic.org.dom4j.Element))) {
/* 221 */       return ((com.newrelic.org.dom4j.Element)node).attributeCount() > 0;
/*     */     }
/* 223 */     return false;
/*     */   }
/*     */ 
...
/* 370 */       com.newrelic.org.dom4j.Node node = parent.node(i);
/*     */ 
/* 372 */       if ((node instanceof com.newrelic.org.dom4j.Element)) {
/* 373 */         com.newrelic.org.dom4j.Element element = (com.newrelic.org.dom4j.Element)node;
/*     */ 
...
/* 390 */       com.newrelic.org.dom4j.Node node = parent.node(i);
/*     */ 
/* 392 */       if ((node instanceof com.newrelic.org.dom4j.Element)) {
/* 393 */         com.newrelic.org.dom4j.Element element = (com.newrelic.org.dom4j.Element)node;
/*     */ 
...
/* 422 */           return null;
/*     */         }
/* 424 */         return DOMNodeHelper.asDOMNode((com.newrelic.org.dom4j.Node)this.val$list.get(index));
/*     */       }
/*     */ 
...
/*     */   }
/*     */ 
/*     */   public static org.w3c.dom.Node asDOMNode(com.newrelic.org.dom4j.Node node)
/*     */   {
/* 435 */     if (node == null) {
/* 436 */       return null;
/*     */     }
...
/*     */   }
/*     */ 
/*     */   public static org.w3c.dom.Document asDOMDocument(com.newrelic.org.dom4j.Document document)
/*     */   {
...
/*     */   }
/*     */ 
/*     */   public static org.w3c.dom.DocumentType asDOMDocumentType(com.newrelic.org.dom4j.DocumentType dt)
/*     */   {
/* 467 */     if (dt == null) {
/* 468 */       return null;
/*     */     }
...
/*     */   }
/*     */ 
/*     */   public static org.w3c.dom.Element asDOMElement(com.newrelic.org.dom4j.Node element)
/*     */   {
/* 497 */     if (element == null) {
/* 498 */       return null;
/*     */     }
...
/*     */   }
/*     */ 
/*     */   public static Attr asDOMAttr(com.newrelic.org.dom4j.Node attribute)
/*     */   {
 ...
 * Qualified Name:     com.newrelic.org.dom4j.dom.DOMNodeHelper
