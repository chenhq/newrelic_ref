...
/* 92 */   public static final String[] opNames = { "!=", "%=", "&=", "*=", "+=", "-=", "/=", "<=", "==", ">=", "^=", "|=", "++", "--", "<<", "<<=", ">>", ">>=", "||", "&&", ">>>", ">>>=" };
/*    */ 
/* 98 */   public static final int[] assignOps = { 37, 38, 42, 43, 45, 47, 0, 0, 0, 94, 124, 0, 0, 0, 364, 0, 366, 0, 0, 0, 370 };
 ...
 * Qualified Name:     com.newrelic.javassist.compiler.TokenId
